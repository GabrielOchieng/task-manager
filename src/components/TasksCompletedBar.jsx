...
//   // Group tasks by assigned user ID and completion status
//   const tasksPerUser = tasks.reduce((acc, task) => {
//     const userId = task.assignedTo.name;
//     const isCompleted = task.completed;

//     if (!acc[userId]) {
//       acc[userId] = { completed: 0, incomplete: 0 };
//     }

//     acc[userId][isCompleted ? "completed" : "incomplete"]++;
...
//   const completedTasksPerUser = userLabels.map(
//     (userId) => tasksPerUser[userId].completed
//   );
//   const incompleteTasksPerUser = userLabels.map(
//     (userId) => tasksPerUser[userId].incomplete
//   );
...
//         borderWidth: 1,
//         stack: "tasks", // Stack bars for each user
//       },
//       {
